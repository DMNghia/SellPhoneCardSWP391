                    ...
                    <div class="signup-form">
                        <form id="form-signup" method="post" action="register">
                            ...
                            <div class="form-row">
                                ...
                                <div class="input-area">
                                    <input style="font-size: 1.5em" id="password-input" type="password" name="password"><br>
                            ...
                            <div class="form-row">
                                ...
                                <div class="input-area">
                                    <input style="font-size: 1.5em" id="email-input" type="text" name="email"><br>
                            ...
                            <div class="form-row">
                                ...
                                <div class="input-area" style="display: flex">
                                    ...
                                    <div class="captcha-div">
                                        ...
                                        <p style="color: red;" id="captcha-validate" class="message-error"></p>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
