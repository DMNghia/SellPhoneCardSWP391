...
INSERT INTO `sellphonecard`.`transactions` (`id`, `user`, `orderId`, `money`, `note`, `type`, `status`) VALUES ('1', '2', '2', '30000', 'mua the ', '1', '1');
INSERT INTO `sellphonecard`.`transactions` (`id`, `user`, `orderId`, `money`, `note`, `type`, `status`) VALUES ('2', '2', '3', '40000', 'mua cho ny', '0', '1');
INSERT INTO `sellphonecard`.`transactions` (`id`, `user`, `orderId`, `money`, `note`, `type`, `status`) VALUES ('3', '2', '4', '32423', 'mua the viettel', '0', '0');
INSERT INTO `sellphonecard`.`transactions` (`id`, `user`, `orderId`, `money`, `note`, `type`, `status`) VALUES ('4', '2', '5', '6000', 'nap dien thoai', '1', '0');